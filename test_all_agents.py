...
async def run_all_tests():
    ...
    query3 = "Como a Convenção Americana de Direitos Humanos protege a liberdade de expressão?"
    result3 = await manager.process_query(query3)
    print("\n✅ Resultado do Teste de Direitos Humanos:")
    pprint(result3["final_answer"])
